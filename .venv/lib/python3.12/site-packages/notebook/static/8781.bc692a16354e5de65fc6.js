...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(88160);
...
async function main() {
  const mimeExtensionsMods = [
    __webpack_require__(88127),
    __webpack_require__(38038),
    __webpack_require__(49825),
    __webpack_require__(21779),
  ];
  ...
  __webpack_require__(35615),
  __webpack_require__(75618),
  __webpack_require__(74583),
  __webpack_require__(43058),
  __webpack_require__(83846),
  
      (__webpack_require__(4301)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(32968)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
  ...
  __webpack_require__(91957),
  
      (__webpack_require__(94210)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(74489)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(62585),
  
      (__webpack_require__(72067)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(70963)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(11880)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(32204)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(48474)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(89706),
  __webpack_require__(62009),
  __webpack_require__(1625),
  __webpack_require__(99391),
  
      (__webpack_require__(82282)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(29118),
  __webpack_require__(1147),
  __webpack_require__(26654),
  
      (__webpack_require__(38096)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
  ...
  __webpack_require__(15701),
  __webpack_require__(50065),
  __webpack_require__(55421),
  __webpack_require__(8847),
  __webpack_require__(99121),
  __webpack_require__(36930),
  __webpack_require__(94786),
  __webpack_require__(26061),
  ...
  switch (page) {
    ...
    case '/tree': {
      baseMods = baseMods.concat([
        __webpack_require__(88067),
  __webpack_require__(31882),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      (__webpack_require__(74879)["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(10837),
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(70990),
  __webpack_require__(88067),
  
      (__webpack_require__(47080)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(12432)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(1233)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(60910).NotebookApp);

  pluginRegistry.registerPlugins(mods);
  const IServiceManager = (__webpack_require__(69795).IServiceManager);
...
//# sourceMappingURL=8781.bc692a16354e5de65fc6.js.map?v=bc692a16354e5de65fc6